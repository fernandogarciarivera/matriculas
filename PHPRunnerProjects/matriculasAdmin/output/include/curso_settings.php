...
{
	$fieldLabelscurso["English"] = array();
	$fieldToolTipscurso["English"] = array();
	$placeHolderscurso["English"] = array();
	$pageTitlescurso["English"] = array();
	$fieldLabelscurso["English"]["idCurso"] = "Id Curso";
	$fieldToolTipscurso["English"]["idCurso"] = "";
	$placeHolderscurso["English"]["idCurso"] = "";
	$fieldLabelscurso["English"]["NombreCurso"] = "Nombre Curso";
	$fieldToolTipscurso["English"]["NombreCurso"] = "";
	$placeHolderscurso["English"]["NombreCurso"] = "";
	$fieldLabelscurso["English"]["Seccion"] = "Seccion";
	$fieldToolTipscurso["English"]["Seccion"] = "";
	$placeHolderscurso["English"]["Seccion"] = "";
	$fieldLabelscurso["English"]["NRC"] = "NRC";
	$fieldToolTipscurso["English"]["NRC"] = "";
	$placeHolderscurso["English"]["NRC"] = "";
	$fieldLabelscurso["English"]["Academia"] = "Academia";
	$fieldToolTipscurso["English"]["Academia"] = "";
	$placeHolderscurso["English"]["Academia"] = "";
	$fieldLabelscurso["English"]["DiasClase"] = "Dias Clase";
	$fieldToolTipscurso["English"]["DiasClase"] = "";
	$placeHolderscurso["English"]["DiasClase"] = "";
	$fieldLabelscurso["English"]["HorasClase"] = "Horas Clase";
	$fieldToolTipscurso["English"]["HorasClase"] = "";
	$placeHolderscurso["English"]["HorasClase"] = "";
	$fieldLabelscurso["English"]["idCicloEscolar"] = "Id Ciclo Escolar";
	$fieldToolTipscurso["English"]["idCicloEscolar"] = "";
	$placeHolderscurso["English"]["idCicloEscolar"] = "";
	if (count($fieldToolTipscurso["English"]))
