...
class ConnectionManager
{
	...
	{
		return $this->byId( "matriculas_at_127_0_0_1" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data["connName"] = "matriculas at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;;3306;matriculas;;1"; //currently unused

		$this->_connectionsIdByName["matriculas at 127.0.0.1"] = "matriculas_at_127_0_0_1";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=127.0.0.1;Uid=root;Pwd=;Port=3306;Database=matriculas;OPTION=3";
		// encription set
		...
		$connectionsData["matriculas_at_127_0_0_1"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["alumno"] = "matriculas_at_127_0_0_1";
		$connectionsIds["profesor"] = "matriculas_at_127_0_0_1";
		$connectionsIds["curso"] = "matriculas_at_127_0_0_1";
