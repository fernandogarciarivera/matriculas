...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "alumno", "varname" => "matriculas_at_127_0_0_1__alumno", "altvarname" => "alumno", "connId" => "matriculas_at_127_0_0_1", "schema" => "", "connName" => "matriculas at 127.0.0.1");
		$this->lstTables[] = array("name" => "curso", "varname" => "matriculas_at_127_0_0_1__curso", "altvarname" => "curso", "connId" => "matriculas_at_127_0_0_1", "schema" => "", "connName" => "matriculas at 127.0.0.1");
		$this->lstTables[] = array("name" => "profesor", "varname" => "matriculas_at_127_0_0_1__profesor", "altvarname" => "profesor", "connId" => "matriculas_at_127_0_0_1", "schema" => "", "connName" => "matriculas at 127.0.0.1");
		$this->lstTables[] = array("name" => "profesor_curso", "varname" => "matriculas_at_127_0_0_1__profesor_curso", "altvarname" => "profesor_curso", "connId" => "matriculas_at_127_0_0_1", "schema" => "", "connName" => "matriculas at 127.0.0.1");
	}
