...
{
	$fieldLabelsprofesor["English"] = array();
	$fieldToolTipsprofesor["English"] = array();
	$placeHoldersprofesor["English"] = array();
	$pageTitlesprofesor["English"] = array();
	$fieldLabelsprofesor["English"]["idProfesor"] = "Id Profesor";
	$fieldToolTipsprofesor["English"]["idProfesor"] = "";
	$placeHoldersprofesor["English"]["idProfesor"] = "";
	$fieldLabelsprofesor["English"]["NomProfesor"] = "Nom Profesor";
	$fieldToolTipsprofesor["English"]["NomProfesor"] = "";
	$placeHoldersprofesor["English"]["NomProfesor"] = "";
	$fieldLabelsprofesor["English"]["ApellidosProfesor"] = "Apellidos Profesor";
	$fieldToolTipsprofesor["English"]["ApellidosProfesor"] = "";
	$placeHoldersprofesor["English"]["ApellidosProfesor"] = "";
	$fieldLabelsprofesor["English"]["bitacora"] = "Bitacora";
	$fieldToolTipsprofesor["English"]["bitacora"] = "";
	$placeHoldersprofesor["English"]["bitacora"] = "";
	if (count($fieldToolTipsprofesor["English"]))
