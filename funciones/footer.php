	...
	<div class="container py-4 py-lg-5">
		<div class="row row-cols-2 row-cols-md-4">
			<div class="col-12 col-md-6">
				<div class="fw-bold d-flex align-items-center mb-2"><span>Nuestro Proyecto</span></div>
				<p class="text-muted" style="font-size: 14px;">Trabajo final de Taller de Programación Web - Aplicación Web de Gestión de Matriculas.</p>
			</div>
			<div class="col-sm-6 col-md-3 text-lg-start d-flex flex-column">
				<h3 class="fs-6 fw-bold">Curso Profesor</h3>
				<ul class="list-unstyled" style="font-size: 14px;">
					<li><a href="#">Taller de Programación Web</a></li>
					<li class="text-black-100">Docente: Mg. Liu Phol Ramos Fernandez</li>
				</ul>
			</div>
			<div class="col-sm-6 col-md-3 text-lg-start d-flex flex-column">
