...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "alumno" ] = array( "url" => "alumno", "type" => 0 );
	$projectEntitiesReverse[ "alumno" ] = "alumno";
	$projectEntities[ "profesor" ] = array( "url" => "profesor", "type" => 0 );
	$projectEntitiesReverse[ "profesor" ] = "profesor";
	$projectEntities[ "curso" ] = array( "url" => "curso", "type" => 0 );
	$projectEntitiesReverse[ "curso" ] = "curso";
	$projectEntities[ "profesor_curso" ] = array( "url" => "profesor_curso", "type" => 0 );
	$projectEntitiesReverse[ "profesor_curso" ] = "profesor_curso";
	$projectEntities[ "horarios" ] = array( "url" => "horarios", "type" => 0 );
