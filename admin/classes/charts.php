...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("alumno" == $this->chrt_array['tables'][0])
			return true;
		if("profesor" == $this->chrt_array['tables'][0])
			return true;
		if("curso" == $this->chrt_array['tables'][0])
			return true;
		if("profesor_curso" == $this->chrt_array['tables'][0])
			return true;
		if("horarios" == $this->chrt_array['tables'][0])
			return true;
