...
require_once("include/mimatricula_curso_horario_view_variables.php");
...
$keys = array();
$keys["IdmatriculaCab"] = postvalue("editid1");
$keys["idMatricula"] = postvalue("editid2");
$keys["idAlumno"] = postvalue("editid3");
$keys["idCursoDicta"] = postvalue("editid4");
$keys["idCurso"] = postvalue("editid5");
$keys["idProfesor"] = postvalue("editid6");
$keys["IdHorario"] = postvalue("editid7");
