<?php
$dalTablealumno_profesor_curso = array();
$dalTablealumno_profesor_curso["IdmatriculaCab"] = array("type"=>3,"varname"=>"IdmatriculaCab", "name" => "IdmatriculaCab");
$dalTablealumno_profesor_curso["idMatricula"] = array("type"=>3,"varname"=>"idMatricula", "name" => "idMatricula");
$dalTablealumno_profesor_curso["idAlumno"] = array("type"=>3,"varname"=>"idAlumno", "name" => "idAlumno");
...
$dalTablealumno_profesor_curso["estadoMatricula"] = array("type"=>3,"varname"=>"estadoMatricula", "name" => "estadoMatricula");
	...
	$dalTablealumno_profesor_curso["idAlumno"]["key"]=true;

$dal_info["matriculas_at_127_0_0_1__alumno_profesor_curso"] = &$dalTablealumno_profesor_curso;
?>